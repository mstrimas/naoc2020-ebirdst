...
# project
la_proj <- st_transform(la, crs = map_pars$custom_projection)
la_sinu <- st_transform(la, crs = st_crs(abd_breeding))
```
...
```{r local-quarters}
# mask to louisiana
abd_breeding_la <- mask(abd_breeding_proj, la_proj) %>% 
  trim()
