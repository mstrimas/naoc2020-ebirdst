...
In this lesson, we'll learn how to download eBird Status & Trends data using the R package [`ebirdst`](https://cornelllabofornithology.github.io/ebirdst/), load them into R and make a simple map.
...
Data for 610 North American bird species are available through `ebirdst`. The `ebirdst_runs` object is a data frame of all the available species, including their unique run names and the seasonal dates for each.
